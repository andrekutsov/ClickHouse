...
Убирает пробелы между элементами массива.
...
Исходный массив без пробелов между элементами.

**Пример**

Передан массив. Между его элементами в произвольном порядке вставлены пробелы.
...
```text
┌─topKArray(array(array([1], [2]), array([3], [4])))─┐
│ [[[1],[2]],[[3],[4]]]                              │
└────────────────────────────────────────────────────┘
```
