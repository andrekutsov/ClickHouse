...
Возвращает массив значений по частоте их встречаемости.
...
- `array` — [массив](../../data_types/array.md).
- `N` — количество возвращаемых значений. Опциональный параметр.

**Возвращаемое значение**

Массив значений без дубликатов, в котором значения отсортированы по убыванию частоты встречаемости (а не по самим значениям).

**Пример**

Передан массив без указания сколько значений нужно вернуть.
